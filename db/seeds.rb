...
demo_user = User.create!(email: 'demo@demo.demo', username: 'Demo User', password: 'password')
...
dm_test = DirectMessage.create!()

Subscription.create!({user_id: 1, subscribeable: dm_test})
Subscription.create!({user_id: 2, subscribeable: dm_test})
